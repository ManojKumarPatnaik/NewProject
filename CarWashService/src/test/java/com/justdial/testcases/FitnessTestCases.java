...
public class FitnessTestCases extends Homepage {
	...
	public void fitness() {
		...
		visibilitywaitwithclick("//ul[@id='cuto']/li", 30);
		test1.info("The Fitness Menu Is Clicked");
		visibilitywaitwithclick("//ul[@class='hotkeys-list ']//li/a[contains(@title,'Fitness')]", 30);
	...
	public void gym() {
		...
		visibilitywaitwithclick("//ul[contains(@class,'listview')]//li/a/span[@title='Gym']", 30);
